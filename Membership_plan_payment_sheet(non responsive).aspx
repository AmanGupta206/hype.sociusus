<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Membership_plan_payment_sheet(non responsive).aspx.cs" Inherits="hype.sociusus.Membership_plan_payment_sheet" %>
                             ...
                             <div class="row">
                                 <div class="col-md-4">
                                     <div class="card">
                                         <div class="card-body">
                                             <h4>Free Plan</h4>
                                             <div style="background-color: #f5f5f5; padding-left: 110px; padding-right: 100px;">
                                                 <h2>Free</h2>
                                             </div>
