<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Speech_to_text.aspx.cs" Inherits="hype.sociusus.Speech_to_text1" %>
...
<head runat="server">
    ...
    <link href="fontawesome/css/all.css" rel="stylesheet" />
     ...
     <%--Custom css--%>
    <link href="css/Speech_to_text.css" rel="stylesheet" />
                ...
                <div  class ="main"> 
                    <div class="row FirstRow">
                           ...
                           <div class="col-md-6"   >  
                               ...
                               <a class="btn btn-secondary rtbtn" href="homepage.aspx" role="button">Home >> Speech to text</a>
                           </div>
                    </div>
<%-- main part code--%>
                                ...
                                <div class ="card" style="padding: 17px;">
                                    ...
                                    <div>
                                        <h5>Audio Description</h5>
                                         <textarea class="textArea2" maxlength="200" style=" width: 95%;min-height: 70px;"></textarea>
