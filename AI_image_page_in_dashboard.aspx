<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AI_image_page_in_dashboard.aspx.cs" Inherits="hype.sociusus.AI_image_page_in_dashboard" %>
                  ...
                  <div  class ="main"> 
                    <div class="row"  >
                           ...
                           <div class="col-md-6"   style="padding-top: 200px; padding-left:275px;">  
                               ...
                               <asp:Button class="btn btn-secondary"  ID="Button1" runat="server" Text="Home >>AI Images" /> 
