<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_AI_Chat_Page.aspx.cs" Inherits="hype.sociusus.Dashboard_AI_Chat_Page" %>
...
<head runat="server">
   ...
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" rel="stylesheet"/>    
    ...
    <link href="fontawesome/css/all.css" rel="stylesheet" />
     ...
     <%--Custom css--%>
    <link href="css/Dashboard_AI_Chat_Page.css" rel="stylesheet" />
    ...
    <%-- main part code--%>
                <div  class ="main"> 
                    <div class="row FirstRow">
                           ...
                           <div class="col-md-6">                             
                               <a class="btn btn-secondary rtbtn" href="homepage.aspx" role="button">Home >> AI Chat</a>
                           </div>
                    </div>
                    <div class="row">    
                        <div   style="margin-left: 2%; margin-right: 2%;margin-top: 2%;">
                            <p style="background-color:#ffe9e9; color: #de5959; width: 101%;" >You can not use the chat feature with your OpenAI model. Upgrade your membership plan to use this feature.</p>    
                        </div>
                    </div>            
                    <div class="card">
                      <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <asp:Button ID="Button1" runat="server" Text="Sent" OnClick="Button1_Click1"  />
                        </div>
                    </div>
