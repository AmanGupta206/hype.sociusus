<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_Affiliate_Program.aspx.cs" Inherits="hype.sociusus.Dashboard_Affiliate_Program1" %>
...
<head runat="server">
   ...
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" rel="stylesheet"/>    
    ...
    <link href="fontawesome/css/all.css" rel="stylesheet" />
     ...
     <%--Custom css--%>
    <link href="css/Dashboard_Affiliate_Program.css" rel="stylesheet" />
            ...
            <div class="col-lg-9 RightMainPart">
                ...
                <div  class ="main"> 
                    <div class="row FirstRow">
                           <div class="col-md-6">  
                                    <div class="alldoc"><h2>Affiliate Program</h2></div>                            
                           </div>
                           <div class="col-md-6"   >  
                               <%--<asp:Button class="btn btn-secondary rtbtn"  ID="Button1" runat="server" Text="Home >> Dashboard"  /> --%>
                               <a class="btn btn-secondary rtbtn" href="homepage.aspx" role="button">Home >> Affiliate Program</a>
                           </div>
                    </div>
                <%-- main part code--%>
                    <div class ="cards">
