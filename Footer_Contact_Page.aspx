<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Footer_Contact_Page.aspx.cs" Inherits="hype.sociusus.Footer_Contact_Page1" %>
...
<head runat="server">
    ...
    <%--Custom css--%>
    <link href="css/Footer_Contact_Page.css" rel="stylesheet" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="row FirstRow" style="background-color: #f5f5f5;">
            ...
            <div class="col-md-6" style="padding-right: 9%;">
                ...
                <a class="btn btn-secondary rtbtn" href="homepage.aspx" role="button">Home >> Contact Us</a>
            </div>
        </div>
                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="card" style="padding: 2rem;">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <textarea name="message" id="message" style="width: 100%;" class="with-border" rows="7" placeholder="Message"></textarea>
                                        </div>
                                    </div>
