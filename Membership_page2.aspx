<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Membership_page2.aspx.cs" Inherits="hype.sociusus.Membership_page21" %>
...
<head runat="server">
   ...
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" rel="stylesheet"/>    
    ...
    <link href="fontawesome/css/all.css" rel="stylesheet" />
     ...
     <%--Custom css--%>
    <link href="css/Membership_page2.css" rel="stylesheet" />
            ...
            <div class="col-lg-9 RightMainPart">
                ...
                <div  class ="main"> 
                    <div class="row FirstRow">
                           <div class="col-md-6">  
                                    <div class="alldoc" style="display:flex"><h2>Current Plan</h2></div>                            
                           </div>
                           <div class="col-md-6"   >  
                               <%--<asp:Button class="btn btn-secondary rtbtn"  ID="Button1" runat="server" Text="Home >> Dashboard"  /> --%>
                               <a class="btn btn-secondary rtbtn" href="homepage.aspx" role="button">Home >> Current Plan</a>
                           </div>
                    </div>
                <%-- main part code--%>
               <div class="row">                
                               ...
                               <div class="table-responsive">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                           <%-- <a href=""><asp:Button  class="btn btn-primary btn-block btn-sm" ID="Button2" runat="server" Text="Change Plan" OnClick="Button2_Click"  /></a>--%>
                                             <a class="btn btn-secondary" href="Membership_plan_payment_sheet.aspx" role="button" style="width: 100%;background-color: blue;">Change Plan</a>
                                      </div>
                                   </div>                             
                               </div>
